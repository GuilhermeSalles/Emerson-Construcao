...
<div class="container mt-4">
    <div class="container" style="background-color: #F8F8F8; box-shadow: -2px 3px 5px 3px #DBDBDB; border-radius: 10px;">
        <h2 class="mb-4" style="color: #333333; font-weight: 700; padding: 1rem;"><i class="fa-solid fa-door-open"></i> Portas e Janelas</h2>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <h5 class="card-title">Vitro Alumínio Branco 1.20x1.00 C/ Grade</h5>
                    <p class="card-text">✅ Pronta Entrega </p>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <h5 class="card-title">Master vitro max ar 60x60 c/gd aluminio branco</h5>
                    <p class="card-text">✅ Pronta Entrega </p>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <h5 class="card-title">Vitro 1,00x1,20 c/gd aluminio branco </h5>
                    <p class="card-text">✅ Pronta Entrega </p>
