...
<div class="container mt-4">
    <div class="container" style="background-color: #F8F8F8; box-shadow: -2px 3px 5px 3px #DBDBDB; border-radius: 10px;">
        <h2 class="mb-4" style="color: #333333; font-weight: 700; padding: 1rem;"><i class="fa-solid fa-trowel-bricks"></i> Construção</h2>
    </div>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="card">
                ...
                <div class="card-footer text-center">
                    <h4>R$ 33,90 à vista <strong>(retira)</strong> </h4>
